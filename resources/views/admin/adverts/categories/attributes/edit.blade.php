...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.adverts.categories.attributes.update', [$category, $attribute]) }}">
        ...
        <div class="form-group">
            ...
            <input id="name_am" class="form-control{{ $errors->has('name_am') ? ' is-invalid' : '' }}" name="name_am" value="{{ old('name_am', $attribute->name_am) }}" required>
        ...
        <div class="form-group">
            ...
            <input id="name_ru" class="form-control{{ $errors->has('name_ru') ? ' is-invalid' : '' }}" name="name_ru" value="{{ old('name_ru', $attribute->name_ru) }}" required>
        ...
        <div class="form-group">
            ...
            <input id="name_en" class="form-control{{ $errors->has('name_en') ? ' is-invalid' : '' }}" name="name_en" value="{{ old('name_en', $attribute->name_en) }}" required>
